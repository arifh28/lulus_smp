                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-lg-8">
											...
											<form method="POST" action="<?php echo base_url() ?>index.php/operator/upload_siswa" enctype="multipart/form-data">
										...
										<div class="col-lg-4">
											<p><small>Download file format excel untuk Import Data Siswa</small></p>
											<a href="<?php echo base_url(); ?>assets/back/media/siswa_lulus.xlsx" class="btn btn-sm btn-info"><i class="fas fa-download"></i> DOWNLOAD FORMAT</a>
										</div>
                                    </div>
                                </div>
                            </div>
